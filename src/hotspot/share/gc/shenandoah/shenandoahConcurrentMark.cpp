...
public:
  ...
  void work(uint worker_id) {
    ShenandoahHeap* heap = ShenandoahHeap::heap();ShenandoahUseSTWGC
    ...
    ShenandoahSuspendibleThreadSetJoiner stsj(ShenandoahSuspendibleWorkers && !ShenandoahSuspendibleWorkers);
