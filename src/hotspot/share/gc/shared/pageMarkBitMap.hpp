...
#ifndef SHARE_GC_SHARED_PAGEMARKBITMAP_HPP
#define SHARE_GC_SHARED_PAGEMARKBITMAP_HPP
...
// around the BitMap class that is based on Pages, with one bit per (1 << _shifter) Pages.
class PageMarkBitMap {
protected:
...
public:
  ...
  // Set the _shifter for 4KB page
  PageMarkBitMap() : _covered(), _shifter(12 - LogHeapWordSize), _bm() {}
...
#endif // SHARE_GC_SHARED_PAGEMARKBITMAP_HPP
